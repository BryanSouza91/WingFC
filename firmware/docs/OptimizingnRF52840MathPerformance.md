...
Instead of LPF_ALPHA = 0.2, we can use an alpha of 0.25 ($1/4$). Dividing by 4 is the same as a bitwise right-shift by 2 (>> 2), which executes in a single clock cycle.
...
```Go
const PID_SCALE int32 = 1024 // 1024 is better than 1000 because division is a bitshift (>> 10)
