...
* **Code Update:** Initialize a third PWM pin in the FC_Hardware struct and add a yawPID instance.
...
```Go
func ApplyMixer(pitch, roll, yaw, throttle float32) (outputs []float32) {  
